...
case TRANSACTION_registerTearDownApdus:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
android.nfc.ApduList _arg1;
if ((0!=data.readInt())) {
_arg1 = android.nfc.ApduList.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
this.registerTearDownApdus(_arg0, _arg1);
reply.writeNoException();
return true;
}
case TRANSACTION_unregisterTearDownApdus:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.unregisterTearDownApdus(_arg0);
reply.writeNoException();
return true;
}
}
...
public void registerTearDownApdus(java.lang.String packageName, android.nfc.ApduList apdu) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
if ((apdu!=null)) {
_data.writeInt(1);
apdu.writeToParcel(_data, 0);
}
else {
_data.writeInt(0);
}
mRemote.transact(Stub.TRANSACTION_registerTearDownApdus, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void unregisterTearDownApdus(java.lang.String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(packageName);
mRemote.transact(Stub.TRANSACTION_unregisterTearDownApdus, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_registerTearDownApdus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_unregisterTearDownApdus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
}
public android.os.Bundle open(android.os.IBinder b) throws android.os.RemoteException;
public android.os.Bundle close() throws android.os.RemoteException;
public android.os.Bundle transceive(byte[] data_in) throws android.os.RemoteException;
