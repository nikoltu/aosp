...
static final int TRANSACTION_setDefaultInterfaceForDns = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_setDnsServersForInterface = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_flushDefaultDnsCache = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_flushInterfaceDnsCache = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
}
/**
     ** GENERAL
     *//**
